...
namespace Rwb.Luxopus.Jobs
{
    ...
    public class PlanChecker2 : Job
    {
        ...
        public PlanChecker2(ILogger<LuxMonitor> logger, ILuxopusPlanService plans, ILuxService lux, IInfluxQueryService influxQuery, IEmailService email) : base(logger)
        {
            _Plans = plans;
            _Lux = lux;
